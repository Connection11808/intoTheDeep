...
public class ManualFeedforwardTuner extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        ServoretrievalA.setDirection(Servo.Direction.REVERSE); // Inverse control for A
        ...
        while (!isStopRequested()) {
            ...
            ServoretrievalB.setPosition(servoPos); // Left servo (B)
            ServoretrievalA.setPosition(servoPos);// Right servo (A)
