...
public class Trajectory_IntoTheDeep extends LinearOpMode {
...
//        ServoretrievalB.setPosition(servoPos);
        ...
        TrajectorySequence tjs = drive.trajectorySequenceBuilder(StartPos)
                ...
                .lineToLinearHeading(new Pose2d(-59, -59, Math.toRadians(40)))
                .addTemporalMarker(() ->
                {
                ...
                .addTemporalMarker(() ->
                {
                    ...
                    intakeArm.retrievalFrontAuto1();
                    intakeArm.TURN_AUTO_1();
                    lift.TRANSFER_AUTO();
                    outTakeArm.TRANSFER_TELEOP();
                })
                .lineToLinearHeading(new Pose2d(-58, -47, Math.toRadians(62)))
                .addTemporalMarker(() ->
                {
                    intakeArm.goDown();
                })
                ...
                .lineToLinearHeading(new Pose2d(-57, -57, Math.toRadians(30)))
                .addTemporalMarker(() ->
                {
                    outTakeArm.BASKET_8_POINT();
                    lift.BASKET_8_POINT_AUTO();
...
//////////////////////////////////////////////////////////////////////////////////////////////////////
                .lineToLinearHeading(new Pose2d(-59, -50, Math.toRadians(84)))
                .addTemporalMarker(() ->
                {
                    outTakeArm.OUT_TAKE_GRIP_CLOSE();
                    intakeArm.goDown();
                ...
                .lineToLinearHeading(new Pose2d(-58, -45, Math.toRadians(115)))
...
//                    intakeArm.openGrip();
//                    servoPos = servoState.OPEN.value;
//                    intakeArm.retrievalGetSpecFromSub();
//                })
//                .addTemporalMarker(() ->
//                {
//                    lift.TRANSFER_AUTO();
...
//                    intakeArm.openGrip();
//                })
//                .lineToLinearHeading(new Pose2d(-59, -59, Math.toRadians(30)))
//                .addTemporalMarker(() ->
//                {
//                    outTakeArm.BASKET_8_POINT();
//                    lift.BASKET_8_POINT_AUTO();
